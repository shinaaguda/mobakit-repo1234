...
export class EmailComponent implements OnInit {
  ...
  CustomerEmail(regForm: any) {
    ...
    this.http.post('mobikart-lb-1573708540.us-east-1.elb.amazonaws.com/sendEmail', JSON.stringify(this.model), { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) }).subscribe((res) => {
      this.result = res
