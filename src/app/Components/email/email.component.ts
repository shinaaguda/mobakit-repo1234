...
export class EmailComponent implements OnInit {
  ...
  CustomerEmail(regForm: any) {
    ...
    this.http.post('http://att-alb-1200855601.us-east-1.elb.amazonaws.com/sendEmail', JSON.stringify(this.model), { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) }).subscribe((res) => {
      this.result = res
